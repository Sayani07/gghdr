...
This event is quite different in the sense that it is mostly invite-only, where past attendees can recommend new ones. Mitch was a participant at [rOpenSci OzUnconf 2018](https://ozunconf18.ropensci.org/#about). So he invited me to work on this project with him at rOpenSci ozunconf 2019. Soon I applied and we were accepted. Thanks to the organizers of the [rOpenSci ozunconference](https://ozunconf19.ropensci.org/) for the opportunity and excellent management of what has turned out to be a highly stimulating experience. 
